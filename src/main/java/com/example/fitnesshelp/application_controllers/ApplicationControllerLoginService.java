...
import com.example.fitnesshelp.dao.daoLogin;
...
public class ApplicationControllerLoginService {
    ...
    public boolean isValidUser(String username, String password) {
        ...
        daoLogin check = new daoLogin("C:\\Users\\Samuele\\OneDrive - Universita' degli Studi di Roma Tor Vergata\\Università\\Materie\\3 anno\\ISPW\\src\\main\\java\\com\\example\\fitnesshelp\\fileSystem");
